export const siteConfig = {
  ...
  skills: [
    ...
    "3D CAD: SolidWorks, PTC-Creo, AutoCAD, Onshape",
    "Prototyping: FDM, SLA, Laser Cutter, Power and Hand Tools",
    "Programming: Python, C++, JavaScript, MATLAB, Minitab"
  ],
  ...
  education: [
    {
      ...
      achievements: [
        ...
        "Treasurer of the American Society of Mechanical Engineers",
      ],
    },
  ],
};
